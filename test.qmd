...
![](Demarche.jpg)
![](https://github.com/AnsaldiL/MLB_forest/blob/main/Demarche.jpg?raw=true)
...
>>>>>>> 594ca74e5a7d9a7277218afc31496c30dc91f856
...
Selection variable random forest multinom: lesquelles sont importantes
...
\- Pour les datas driven methods: + de données = + accuracy - Différence KNN

-   Mais pas possible d'utiliser toutes les données pour regression:

\- Random forest/KNN : la dimension reduction des KNN entraine une perte d'information par rapport au deux autres algo.

-   Methode regression multinoamiale comparable au knn et random forest avec données: normalemt équivalent

-   Conclu final:

-   Ce qui aurait être fait en continuité de la multinom réseau de neurones. Nous on a pas fait reseau de neurone fait dans comparaison à l'article, eux ils ont fait le réseau de neurone --\> comparer leur accuracy. Apparament modele plus simple prédise mieux

Donc en conclusion pour ce jeu de données ce qui marche bien, c'est bcp de données et methode simple
